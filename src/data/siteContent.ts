...
export const siteContent = {
  ...
  topicIntro: "Topics of interest include, but are not limited to:",
  topics: [
    {
      title: "Foundations of (Unified) Intelligence",
      question:
        "What are the fundamental principles underlying intelligence in brains, agents, and robots?",
      topics: [
        "Mathematical and computational foundations of intelligence",
        "Theoretical frameworks for biological and artificial intelligence",
        "Unified theories of intelligence",
        "Principles of cognition, learning, adaptation, decision-making, and intelligent behavior",
      ],
    },
    {
      title: "Brain-Inspired Agentic AI",
      question:
        "How can insights from neuroscience and cognitive science improve autonomous agents and intelligent decision making?",
      topics: [
        "Cognitive architectures for agents",
        "Memory, abstraction, and knowledge representation",
        "Brain-inspired reasoning and planning",
        "Learning and adaptation in biological and artificial systems",
      ],
    },
    {
      title: "Brain-Inspired Physical AI",
      question:
        "How can principles of biological intelligence support learning and adaptation in embodied systems?",
      topics: [
        "Computational neuroscience for robotics",
        "Neuro-inspired robot perception, learning, and control",
        "Brain-inspired world models and planning",
        "Neuromorphic robotics and autonomous systems",
      ],
    },
    {
      title: "Agentic Robotics",
      question: "How can autonomous agents operate effectively in physical environments?",
      topics: [
        "Agentic AI for robotic systems",
        "Robot foundation models and vision-language-action systems",
        "Multi-robot and multi-agent collaboration",
        "Open-world robotic intelligence",
      ],
    },
    {
      title: "Integrated Systems, Resources, and Applications",
      question:
        "How can cognition, agency, and embodiment be integrated into next-generation intelligent systems?",
      topics: [
        "Human-AI-robot collaboration and ecosystems",
        "Integrated/hybrid cognitive-agentic-robotic systems",
        "Benchmarks, datasets, tools, and platforms (for research and/or development)",
        "Real-world deployments and applications of intelligent agents and robots",
      ],
    },
  ] satisfies TopicArea[],
  schedule: [
  ...
  speakers: {
    ...
    people: [
      ...
      },
      {
        name: "Andrew Zalesky",
        title:
          "Professor and Professorial Fellow, Department of Biomedical Engineering and Department of Psychiatry, University of Melbourne",
        shortTitle: "University of Melbourne",
        website: "https://findanexpert.unimelb.edu.au/profile/24599-andrew-zalesky",
        bio: "Prof. Andrew Zalesky is a Professor and Professorial Fellow at the University of Melbourne, affiliated with the Department of Biomedical Engineering and Department of Psychiatry. His research spans neuroinformatics, neural engineering, neuroscience, neuroimaging, connectomics, brain stimulation, and network science.",
        email: "azalesky@unimelb.edu.au",
        image: {
          src: "/images/speakers/andrew-zalesky.jpg",
          alt: "Andrew Zalesky",
          status: "downloaded",
          source: "University of Melbourne Find an Expert profile photo",
        },
      },
    ] satisfies Speaker[],
  },
